...
if(isset($_POST['edit_sms'])){ 
    ...
    $new_desc = mysqli_real_escape_string($connect,$_POST['message']);
    $new_status = mysqli_real_escape_string($connect,$_POST['tstatus']);
	    
    $sqladd="UPDATE tbl_sms_templates SET message='$new_desc',status='$new_status' WHERE id='$new_id'";
    
    $result_update=mysqli_query($connect,$sqladd);
    if($result_update){
        
        echo '<script>window.location.href="sms_templates.php"</script>';
    }
    else{
...
<html>
    <head>
        <head>
	<title>Settings | SMS Templates</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">SMS Templates</h3>
                                        </div>
                                    <br>
                                    <div class="panel-body">
                                       ...
                                       <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_sms_templates");
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><a href="sms_details.php?id=<?php echo $row['id']?>"><?php echo $row['title']; ?></a></td>
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_sms_templates'>
                                        <input type="hidden" id="returnto" name="returnto" value='../settings/sms_templates.php'>
