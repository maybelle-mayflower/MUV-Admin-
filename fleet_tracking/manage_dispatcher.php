...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Dispatcher</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
                                                                    ...
                                                                    <li>
                                                                     ...
                                                                     <li>
                                                                        ...
                                                                        <div id="subPagesb" class="collapse ">
                                                                            <ul class="nav">
                                                                                <li><a href="manage_dispatcher.php" class="active">Manage Dispatchers</a></li>
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Manage Dispatcher</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Manage Dispatchers</h3>
                                        </div>
                                       
                                    <br>
                                    <form action="showChecked.php" method="post">
                                        <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">                                            <thead style="font: bolder">
                                                <tr>
                                                    <th>S/No</th>
                                                    <th>Select</th>
                                                   <th>Status</th>
                                                ...
                                                <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT tbl_dispatcher.id AS id, tbl_dispatcher.company AS company_id, tbl_dispatcher.status AS status, tbl_dispatcher.firstname AS firstname, tbl_dispatcher.lastname AS lastname, tbl_dispatcher.email AS email, tbl_dispatcher.mobile AS mobile, tbl_dispatcher.address AS address, tbl_dispatcher.country AS country, tbl_dispatcher.state AS state, tbl_dispatcher.city AS city, companies.company_name AS company_name FROM tbl_dispatcher INNER JOIN companies ON tbl_dispatcher.company=companies.id");
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><select id="dropdown" name="dropdown" data-id="<?php echo $row['id']; ?>"><?php getStatus($row['status']); ?></select></td>
                                                       <td><a href="dispatcher_info.php?id='<?php echo $row['id'];?>'"><?php echo $row['firstname']." ".$row['lastname']; ?></a></td>
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_dispatcher'>
                                        <input type="hidden" id="returnto" name="returnto" value='manage_dispatcher.php'>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
        ...
        var t = $('.table').DataTable( {
           ...
           buttons: [
            ...
            { "text":'Add Dispatcher',"className": 'btn btn-default btn-xs', action: function(){
                    addDispatcher();
            } }
        ]
        } );
    ...
    <script>
        ...
        function addDispatcher(){
            window.open('add_dispatcher.php','_self',false);
        }
    </script>
</body>
</html>
...
if(isset($_POST['btnEdit'])){
    ...
    $new_status="Active";
    $new_name=mysqli_real_escape_string($connect,$_POST['firstname']);
    $lastname = mysqli_real_escape_string($connect,$_POST['lastname']);
    $new_coname=mysqli_real_escape_string($connect,$_POST['txtconame']);
    $new_email=mysqli_real_escape_string($connect,$_POST['email']);
    $new_mobile=mysqli_real_escape_string($connect,$_POST['mobile']);
    $new_address=mysqli_real_escape_string($connect,$_POST['txtaddress']);
    $new_country=mysqli_real_escape_string($connect,$_POST['txtcountry']);
    $new_state=mysqli_real_escape_string($connect,$_POST['txtstate']);
    $new_city=mysqli_real_escape_string($connect,$_POST['txtcity']);
    
    $sqlupdate="UPDATE tbl_dispatcher SET status='$new_status',firstname='$new_name',lastname='$lastname',email='$new_email',mobile='$new_mobile',address='$new_address',company='$new_coname',country='$new_country',state='$new_state',city='$new_city' WHERE id='$new_id'";
