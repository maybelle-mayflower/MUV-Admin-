...
if(isset($_SESSION['uEmail'])){   
    ...
    while($row=mysqli_fetch_array($run_sql)){
        $id=$row['id'];
        $fleet_no=$row['carNumber'];
        $fleet_co=$row['fleet_company'];
        $fleet_model=$row['fleet_model'];
        $fleet_owner=$row['fleet_owner'];
        $fleet_man=$row['fleet_man'];
        $fleet_colour=$row['fleet_colour'];
        $motor_expiry=$row['motor_expiry'];
        $fleet_insurance=$row['fleet_insNo'];
        $insurance_expiry =$row['ins_expiry'];
...
<html>
    <head>
	<title>Fleet Tracking | Manage Drivr</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div class="main">
            ...
            <div class="modal-header">
                <h4 class="modal-title" style="font-weight: bolder;">MUV | Fleet Information</h4>
            </div>
            <div class="modal-body">
                                ...
                                <div class="row">
                                        <div class="col-md-4">
                                                <div class="metric">
                                                        ...
                                                        <p>
                                                            <span class="number" style="font-weight: bold;">0</span>
                                                                <span class="title">Total Distance Traveled</span>
                                                        </p>
                                                </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="metric">
                                                    <span class="icon" style="background-color: orange;"><i class="fa fa-percent"></i></span>
                                                        <p>
                                                                <span class="number" style="font-weight: bold;">0</span>
                                                                <span class="title">Fleet Availability Percentage</span>
                                                        </p>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                                <div class="metric">
                                                        <span class="icon"style="background-color: green;"><i class="fa fa-bar-chart"></i></span>
                                                        <p>
                                                            <span class="number" style="font-weight: bold;">0</span>
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="box-body">
                        <h3 style="text-decoration: underline;">Fleet Information</h3>

                        <div class="form-group">
                            <label class="col-sm-4 control-label required" for="fleetno">Fleet No:</label>
                            <div class="col-sm-6">
                                <p><?php echo $fleet_no;?></p>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-4 control-label required" for="fleetmodel">Fleet Model:</label>
                            <div class="col-sm-6">
                                <p><?php echo $fleet_model;?></p>
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-sm-4 control-label" for="expirydate">Motor Expiry Date:</label>
                            <div class="col-sm-6">
                                <p><?php echo $motor_expiry;?></p>
                            </div>
                        </div>
