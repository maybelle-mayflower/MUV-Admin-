...
<html>
    <head>
        <head>
	<title>Analytics | Consumer Logs</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
                                                                    ...
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        ...
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="consumer_logs.php" class="active">Consumer Logs</a></li>
		...
		<div class="main">
                   <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Consumer Logs</li>
                    </ol>
			<!-- MAIN CONTENT -->
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Consumer Logs</h3>
                                        </div>
