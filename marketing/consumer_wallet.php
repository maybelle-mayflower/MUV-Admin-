...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Consumer Wallet</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
                                                                     ...
                                                                     <li>
                                                                        ...
                                                                        <div id="subPages4b" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="consumer_wallet.php" class="active">Consumer Wallet Log</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </li>
                                                            </ul>
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Consumer Wallet</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Consumer Wallet</h3>
                                        </div>
                                    ...
                                    <form action="showChecked.php" method="post">
                                       <table style="margin: 10px;"class="table table-striped table-bordered" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "select * from tbl_wallet");
