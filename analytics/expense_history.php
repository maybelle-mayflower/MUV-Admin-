...
<html>
    <head>
        <head>
	<title>Analytics | Expense History</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages3" data-toggle="collapse" class=""><i class="lnr lnr-briefcase"></i> <span>Revenue</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages3" class="collapse ">
								<ul class="nav">
                                                                    <li><a href="../revenue/dashboard.php" class="">Dashboard</a></li>
                                                                    <li><a href="../revenue/transactions.php" class="">Transactions</a></li>
									<li>
                                                                        <a href="#subPages3a" data-toggle="collapse" class=""><span>Expense Management</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
                                                                    ...
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        ...
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="expense_history.php" class="active">Expenses History</a></li>
