...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Import</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Upload Driver Photo</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Upload Driver Photo</h3>
                                        </div>
                                    <br>
                                    <div class="col-md-6">
                                        <form action="import_photo.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div style="margin: 20px;">
                                            <h4 style="font-weight:bold;">Upload Guide</h4>

                                            <ul>
                                                <li>You can upload jpeg, png files</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
