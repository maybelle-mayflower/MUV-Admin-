...
<body>
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Payment Gateway Module</h3>
                                        </div>
                                    <br>
                                    ...
                                    <form action="../fleet_tracking/showChecked.php" method="post">
                                       <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_payment_gateway");
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td align="center" style="font-weight: bolder; font-size: 1.2em;"><img src="../assets/icons/<?php echo $row['icon'];?>" class="img-responsive"><?php echo $row['payment_gateway'];?></td>
                                                       <td><input type="radio" name="setDefault" id="setDefault" <?php if($row['is_default']=="y"){echo "checked";}?> data-id="<?php echo $row['id']; ?>"></td>
                                                    </tr>
                                                   <?php endwhile; ?>
                                               </tbody>
                                        </table>
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_payment_gateway'>
                                        <input type="hidden" id="returnto" name="returnto" value='../settings/payments.php'>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
       ...
       <script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script>
        ...
        <script>
        $(document).on('change','#setDefault',function(e){
            e.preventDefault();
            var per_id=$(this).data('id');
               $.ajax({
                        url: "defaultgw_update.php",
                        method:"POST",
                        data:{id:per_id},
