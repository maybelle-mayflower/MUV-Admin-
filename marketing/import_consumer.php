...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Import Consumers</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Import Consumers</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Import Consumers</h3>
                                        </div>
                                    <br>
                                    <form action="import_consumer.php" method="post" enctype="multipart/form-data">
                                        <div class="box-body form-group">
                                        <input type="file" class="form-control" id="consumercsv" name="consumercsv">
                                        </div>
                                        <button type="submit" class="btn btn-default btn-xs" id="importbtn" name="importbtn" style="margin-left: 10px;">Import</button>
                                    
                                    </form>
                                    
                                    <div style="margin: 20px;">
                                        <h4 style="font-weight:bold;">Import Instructions</h4>
                                        
                                        <ol>
                                            <li>Download <a href="#">Sample Import File</a> to see an example</li>
                                            <li>File size should be 8 mB</li>
