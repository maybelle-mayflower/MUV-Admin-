...
if(isset($_POST['addExpBtn'])){ 
    ...
    $sqlupdate="INSERT INTO expense_category (category, status) VALUES ('$exp_cat','Active')";
    ...
    if($result_update){
        ...
        echo '<script>alert("Could not add Category")</script>';
    }
}
?>
...
<body>
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Add Expense Category</h3>
                                        </div> 
                                    <br>
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="add_expensecat.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" id="expcat" name="expcat" required="">
                                                        <br>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
        ...
        <script src="https://cdn.datatables.net/responsive/2.2.1/js/responsive.bootstrap.min.js"></script>
         ...
         <script>
            function goBack(){
                window.open('expense_category.php','_self',false);
            }
        </script>
</body>
</html>
