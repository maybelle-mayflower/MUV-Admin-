...
<html>
    <head>
        <head>
	<title>Settings | Withdrawal Payment</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
								...
								<ul class="nav">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div id="subPages6a" class="collapse ">
                                                                            <ul class="nav">
                                                                                <li><a href="widthdrawal_payment.php" class="active">Widthdrawal Payment Mode</a></li>
		...
		<div class="main">
                   <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Withdrawal Payment Mode</li>
                    </ol>
			<!-- MAIN CONTENT -->
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Cash Withdrawal Mode</h3>
                                        </div>
                                    <br>
                                    ...
                                    <form action="../fleet_tracking/showChecked.php" method="post">
                                       <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_withdraw");
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_withdraw'>
                                        <input type="hidden" id="returnto" name="returnto" value='../settings/widthdrawal_payment.php'>
