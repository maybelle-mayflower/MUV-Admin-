    ...
    <body>
        <div id="demo">
            ...
            <label class="checkbox-inline">
                    <input type="checkbox" checked="true" id="london" name="london">
                    <span>London</span>
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" checked="true" id="sanfrancisco" name="sanfrancisco">
            ...
            <form class="form-inline" style="margin-top: 20px;">
                    <input type="text" class="form-control mb-2 mr-sm-2" name="min" id="min" placeholder="Start Date">
                    <div class="input-group mb-2 mr-sm-2">
                      <input type="text" class="form-control" name="max" id="max" placeholder="End Date">
                    </div>
