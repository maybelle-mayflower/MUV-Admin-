...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Driver Wallet</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
                                                                     ...
                                                                     <li>
                                                                        ...
                                                                        <div id="subPagesb" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="driver_wallet.php" class="active">Driver Wallet</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </li>
                                                            </ul>
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Driver Wallet</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Driver Wallet</h3>
                                        </div>
                                      
                                    <br>
                                        <!--<table class="table table-bordered table-responsive display" id="myTable" width="100%">
