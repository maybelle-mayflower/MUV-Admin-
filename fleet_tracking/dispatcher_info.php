...
if(isset($_SESSION['uEmail'])){    
    ...
    $id = $_GET['id'];
    $sql = "SELECT tbl_dispatcher.id AS id, tbl_dispatcher.company AS company_id, tbl_dispatcher.status AS status, tbl_dispatcher.firstname AS firstname, tbl_dispatcher.lastname AS lastname, tbl_dispatcher.email AS email, tbl_dispatcher.mobile AS mobile, tbl_dispatcher.address AS address, tbl_dispatcher.country AS country, tbl_dispatcher.state AS state, tbl_dispatcher.city AS city, companies.company_name AS company_name FROM tbl_dispatcher INNER JOIN companies ON tbl_dispatcher.company=companies.id  WHERE tbl_dispatcher.id=$id";
...
<html>
    <head>
	<title>Fleet Tracking | Dispatcher Information</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" style="font-weight: bolder;">Dispatcher Information</h4>
                                        </div>
                                        ...
                                        <div class="modal-body row">
                                            ...
                                            <div class="container col-md-12">
                                                ...
                                                <div class="">
                                                    <div class="form-group col-md-6">
                                                        <label class="col-sm-4 control-label" for="txtname">Company Name:</label>
                                                        <div class="col-sm-6">
                                                            <p><?php echo $company?></p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="col-sm-4 control-label" for="txtname">Country:</label>
                                                        <div class="col-sm-6">
                                                            <p><?php echo $country?></p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="col-sm-4 control-label" for="txtemail">State:</label>
                                                        <div class="col-sm-6">
                                                            <p><?php echo $state;?></p>
                                                        </div>
                                                    </div>
						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Company Drivers</h3>
									<div class="right">
						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Company Fleet</h3>
									<div class="right">
										<button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
										<button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
									</div>
