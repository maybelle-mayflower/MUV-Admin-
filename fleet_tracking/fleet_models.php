...
<html>
    <head>
        <head>
	<title>Fleet Tracking | Fleet Models</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
							...
							<div id="subPages2" class="collapse ">
								<ul class="nav">
									  <li><a href="../dispatcher/dashboard.php" class="">Dashboard</a></li>
                                                                    ...
                                                                    <li><a href="../dispatcher/manage_bookings.php" class="active">Manage Bookings</a></li>
		...
		<div class="main">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Fleet Models</li>
                    </ol>
			<!-- MAIN CONTENT -->
                                ...
                                <div class="">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Manage Fleet Models</h3>
                                        </div>
                                    ...
                                    <form action="showChecked.php" method="post">
                                        <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                                ...
                                                <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_fleet");
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_fleet'>
                                        <input type="hidden" id="returnto" name="returnto" value='fleet_models.php'>
  ...
  var t = $('.table').DataTable( {
           ...
           buttons: [
            ...
            { "text":'Add Model',"className": 'btn btn-default btn-xs', action: function(){
                    addmodel();
            } }
        ]
        } );
    ...
    <script>
        ...
        <script>
        function addmodel(){
            window.open('add_model.php','_self',false);
        }
    </script>
</body>
</html>
...
if(isset($_POST['btnSave'])){
    ...
    $new_name=mysqli_real_escape_string($con,$_POST['modname']);
    $model_size=mysqli_real_escape_string($con,$_POST['modelsize']);
    $base_fare=mysqli_real_escape_string($con,$_POST['basefare']);
    $min_km=mysqli_real_escape_string($con,$_POST['minkm']);
    $min_fare=mysqli_real_escape_string($con,$_POST['minfare']);
    $cancellation=mysqli_real_escape_string($con,$_POST['cancellation']);
    $add_fare=mysqli_real_escape_string($con,$_POST['addfee']);
    ...
    $sqlupdate="UPDATE tbl_fleet SET model_name='$new_name',model_size='$model_size',base_fare='$base_fare',min_km='$min_km',min_fare='$min_fare',cancellation_fee='$cancellation',add_fee='$add_fare',km_range='$kmrange',
        below_km='$belowkm',above_km='$abovekm',waiting_charge='$waitfee',fare_per_minute='$farepm',min_speed='$minspeed',night_charge='$nightcharge',description='$description', evening_charge='$eveningcharge'
                WHERE id='$new_id'";
