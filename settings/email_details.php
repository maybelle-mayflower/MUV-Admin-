...
$con=$connect;
   ...
   $id = $_GET['id'];
    ...
    while($row=mysqli_fetch_array($run_sql)){
        $per_id=$row['id'];
        $template_description=$row['templates'];
        $status = $row['status'];
        $title = $row['constant'];
        $subject = $row['subject'];
...
<html>
    <head>
	<title>Marketing| Email Details</title>
	<meta charset="utf-8">
...
<body>
						...
						<li>
							...
							<div id="subPages6" class="collapse ">
								<ul class="nav">
                                                                    ...
                                                                    <li><a href="sms_templates.php" class="">SMS Templates</a></li>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <div id="subPages6a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="payments.php" class="active">Payment Modes</a></li>
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="email_templates.php" method="post" enctype="multipart/form-data">

                                            <div class="box-body">

                                                  <div class="form-group">
                                                    <label class="col-sm-4 control-label required" for="title">Email Title</label>
                                                    <div class="col-sm-6">
                                                        <input  type="text" class="form-control" id="title" name="title" value="<?php echo $title;?>" readonly="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label required" for="title">Template Subject</label>
                                                    <div class="col-sm-6">
                                                        <input  type="text" class="form-control" id="subject" name="subject" value="<?php echo $subject;?>" readonly="true">
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                    <label class="col-sm-4 control-label required" for="description">Description</label>
                                                    <div class="col-sm-6">
                                                        <textarea class="form-control" id="description" name="description" required=""><?php echo $template_description;?></textarea>
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                    ...
                                                    <button type="submit" id=edit_email name="edit_email" class="btn btn-default btn-sm" style=" float: right;">Submit</button>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
        ...
        <script>
            function goBack(){
                window.open('email_templates.php','_self',false);
            }
        </script>
