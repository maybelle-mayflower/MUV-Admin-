									...
									<li>
                                                                        ...
                                                                        <div id="subPages3a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="../revenue/payout.php" class="active">Payout</a></li>
                                                                            </ul>
                                                                        </div
                                                                    </li>
								</ul>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid" style="height: auto;">
                                    <div class="row">
                                            <div class="col-md-4">
                                                    <div class="metric"  style="background-color: white;">
                                                        <img class="icon" style="background-color: whitesmoke;"src="../assets/icons/cash_icon.png">
                                                            <p>
                                                                <span class="number" style="font-weight: bolder;">₦0.00</span>
                                        ...
                                        <div class="col-md-4">
                                                    <div class="metric"  style="background-color: white;">
                                                        <img class="icon" style="background-color: whitesmoke;"src="../assets/icons/commission_icon.png">
                                                            <p>
                                                                    <span class="number" style="font-weight: bolder;">₦0.00</span>
                                                                    <span class="title">Total Paid so far</span>
                                                            </p>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                    <div class="metric"  style="background-color: white;">
                                                        <img class="icon" style="background-color: whitesmoke;"src="../assets/icons/commission_icon2.png">
                                                            <p>
                                                                    <span class="number" style="font-weight: bolder;">₦0.00</span>
                                        ...
                                        <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                                <tr>
                                                 ...
                                                 <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_payout");
