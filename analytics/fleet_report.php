...
<html>
    <head>
        <head>
	<title>Analytics | Fleet Report</title>
	<meta charset="utf-8">
                                                                    ...
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        ...
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="fleet_report.php" class="active">Fleet Report</a></li>
				...
				<div class="container-fluid">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Fleet Report</h3>
                                        </div>
                                        ...
                                        <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   ...
                                                   <tr>
                                                       <td></td>
                                                       <td><a href="../fleet_tracking/fleet_info2.php?id='<?php echo $row['id']; ?>'"><?php echo $row['carNumber']; ?></td>
