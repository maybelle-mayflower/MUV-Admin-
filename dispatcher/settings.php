				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Fleet Dispatch Settings</h3>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <form action="settings.php" method="post">
                                                ...
                                                <table cellspacing="10">
                                                    <tbody>
                                                        <tr>
                                                            <td width="30%"><label>Dispatcher Settings</label></td>
                                                            <td width="60%">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" checked="true" id="auto" name="auto">
                                                                    <span>Auto</span>
                                                                </label>
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" checked="true" id="manual" name="manual">
                                                                    <span>Manual</span>
                                                                </label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="30%"></td>
                                                            <td width="70%"><p>The dispatch settings is used to set the dispatch type as Auto or Manual. Notification is sent to the driver based on the dispatch settings. Auto - Automatically assigns the trip to nearest free drivers. Manual - It shows the available drivers to assign the trip. Auto + Manual - System will asks you to select any one option on Trip dispatch.</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>Later booking time interval</label></td>
                                                            <td><input type="text" name="interval" id="interval" class="form-control" style="width:400px; margin-bottom: 10px;" placeholder="00:00"></td>
                                                        </tr>
                                                        
                                                        <tr style="padding: 10px;">
                                                            <td></td>
                                                            <td style="margin-bottom: 10px;">Later booking - Automatically assign the trips to nearest drivers before this time interval. The driver get busy once got the later bookings.</td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                            <td style="margin-top: 10px;"><button class="btn btn-default">Submit</button></td>
                                                        </tr>
                                                    </tbody>
                                                </table>  
                                    </form>
