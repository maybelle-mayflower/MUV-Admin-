...
if(isset($_POST['addFleet'])){ 
    ...
    //$fleetNo=mysqli_real_escape_string($con,$_POST['fleetno']);
    $fleetCo=mysqli_real_escape_string($con,$_POST['fleetco']);
    $fleetmodel=mysqli_real_escape_string($con,$_POST['fleetmodel']);
    //$carName=mysqli_real_escape_string($con,$_POST['carname']);
    $carNumber=mysqli_real_escape_string($con,$_POST['carno']);
    $fleetOwner=mysqli_real_escape_string($con,$_POST['fleetowner']);
    $manufacturer=mysqli_real_escape_string($con,$_POST['fleetman']);
    $fleetColour=mysqli_real_escape_string($con,$_POST['fleetcolour']);
    $expiryDate=mysqli_real_escape_string($con,$_POST['expirydate']);
    $insuranceNo=mysqli_real_escape_string($con,$_POST['insuranceno']);
    $insuranceExp=mysqli_real_escape_string($con,$_POST['insurance_expiry']);
    $pcoExpiry=mysqli_real_escape_string($con,$_POST['pcoexpiry']);
    $minSpeed=mysqli_real_escape_string($con,$_POST['minimumspeed']);
    $maxLuggage=mysqli_real_escape_string($con,$_POST['maxluggage']);
    $country=mysqli_real_escape_string($con,$_POST['country']);
    $state=mysqli_real_escape_string($con,$_POST['state']);
    $city=mysqli_real_escape_string($con,$_POST['city']);
    $pco_license = mysqli_real_escape_string($con,$_POST['pco_license']);
	
    
    
    $sqlupdate="INSERT INTO tbl_cars (fleet_company, fleet_model, carNumber, status, createdDate, fleet_owner, fleet_man, fleet_colour, motor_expiry, fleet_insNo, ins_expiry, pco_expiry, min_speed, max_luggage, country, state, city, pco_license, isAssigned) VALUES ('$fleetCo','$fleetmodel','$carNumber','Active',NOW(),'$fleetOwner','$manufacturer','$fleetColour','$expiryDate', '$insuranceNo','$insuranceExp','$pcoExpiry','$minSpeed', '$maxLuggage','$country','$state', '$city','NULL','n')";
    $result_update=mysqli_query($con,$sqlupdate);
    if($result_update){
        echo '<script>alert("Fleet Added!")</script>';
...
<html>
    <head>
	<title>Fleet Tracking | Add Fleet</title>
	<meta charset="utf-8">
                                    ...
                                    <div class="modal-content">
                                        <div class="panel panel-headline">
                                            ...
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Add Fleet</h3>
                                                <div class="right">
                                                    <a href="fleets.php" style="float: right;">Exit</a>
                                                </div>
                                            </div>
                                            <?php
                                            global $connect;
                                            ...
                                            <div class="panel-body">
                                                <form class="form-horizontal" action="add_fleet.php" method="post">

                                                    <div class="box-body">
                                                        <p><h4>Fleet Information</h4></p>

                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label required" for="fleetco">Fleet Company</label>
                                                            <div class="col-sm-6">
                                                                <select class="form-control" id="fleetco" name="fleetco" required="">
                                                                    <?php
                                                                    getCompanies();
                                                                    ?>
                                                                </select>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                 <select class="form-control" id="fleetmodel" name="fleetmodel" required=""
                                                                    <?php
                                                                    getModels();
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label required" for="carno">Car Number</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="carno" name="carno" required="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="fleetowner">Fleet Owner Name</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="fleetowner" name="fleetowner">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="fleetman">Fleet Manufacturer</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="fleetman" name="fleetman">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="fleetcolour">Fleet Colour</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="fleetcolour" name="fleetcolour">
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="pco_license" name="pco_license">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="minimumspeed" name="minimumspeed">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="maxluggage">Maximum Luggage(KG)</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="maxluggage" name="maxluggage">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-6">
                                                                <input type="hidden" class="form-control required" id="txtid" name="txtid">
                                                            </div>
                                                        </div>

                                                    </div>
                                                    <button type="submit" id="addFleet" name="addFleet" class="btn btn-default btn-sm" style="float: right;">Submit</button>
                                                </form>
                                            </div>
                                    </div>
                                </div>
