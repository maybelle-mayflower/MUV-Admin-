			...
			<div class="main-content">
				<div class="container-fluid">
					<!-- OVERVIEW -->
                                        <div class="panel panel-headline" style="">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Campaign Users</h3>
                                                <div class="right">
                                            ...
                                            <div class="panel-body" id="full_overview">
                                                ...
                                                global $connect;
                                                $totalUsers = getUsers();
                                                $activeUsers = getActivePassengers();
                                                $inactiveUsers= getUsers() - getActivePassengers();
					...
					<!-- END OVERVIEW -->
                                            ...
                                            <?php
                                             $data = getLoginActivity();
                                             $data2 = newSignUp();
                                            ?>
                                       <div class="panel panel-headline">
                                            <div class="panel-heading">
                                                <h3 class="panel-title" style="font-weight: bold;">User Login Activity</h3>
                                                <div class="right">
							...
							<div class="row">
								<div class="">
									<div id="user_login" style = "margin: 0 auto"></div>
								</div>
							</div>
						</div>
					</div>
                                        ...
                                        <div class="panel panel-headline">
                                            <div class="panel-heading">
                                                <h3 class="panel-title" style="font-weight: bold;">New User Sign-Up</h3>
                                                <div class="right">
                                                        <button type="button" class="btn-toggle-collapse"><i class="lnr lnr-chevron-up"></i></button>
                                                        <button type="button" class="btn-remove"><i class="lnr lnr-cross"></i></button>
                                                </div>
