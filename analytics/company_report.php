...
<html>
    <head>
        <head>
	<title>Analytics | Company Report</title>
	<meta charset="utf-8">
                                                                    ...
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        ...
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="company_report.php" class="active">Company Report</a></li>
				...
				<div class="container-fluid">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Company Report</h3>
                                        </div>
                                        ...
                                        <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%" style="overflow: scroll;">
                                            <thead style="font: bolder">
                                                <tr>
                                                   ...
                                                   <th>Company Name</th>
                                                   <th>Email</th>
                                                   <th>Number of Fleets</th>
                                                   <th>Number of Drivers</th>
                                                   <th>No. of Dispatchers</th>
                                                   
                                                </tr>
                                               </thead>
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM companies WHERE email IS NOT NULL");
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><a href="../fleet_tracking/company_info.php?id='<?php echo $row['id']; ?>'"><?php echo $row['company_name']; ?></a></td>
                                                       <td><?php echo $row['email']; ?></td>
                                                       <td><?php echo fleetNum($row['id'])?></td>
                                                       <td><?php echo driverNum($row['id'])?></td>
                                                       <td><?php echo dispatcherNum($row['id'])?></td>
                                                   </tr>
                                                   <?php endwhile; ?>
                                               </tbody>
                                               <tfoot>
