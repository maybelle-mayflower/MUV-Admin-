...
$con=$connect;
   ...
   $id = $_GET['id'];
    ...
    $sql="select * from tbl_campaign_templates WHERE id=$id";
...
<body>
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="templates.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" id="language" name="language" value="English" readonly="true">
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="radio" id="userType"  name="tstatus" <?php if($status=="Enable"){echo "checked";}?> value="Enable">Enable
                                                      </label>
                                                      <label class="radio-inline">
                                                          <input type="radio" id="userType" name="tstatus"  <?php if($status=="Disable"){echo "checked";}?> value="Disable">Disable
                                                      </label>
                                                    </div>
                                                    ...
                                                    <button type="submit" id=edit_campaign name="edit_campaign" class="btn btn-default btn-sm" style=" float: right;">Submit</button>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
        ...
        <script>
            function goBack(){
                window.open('templates.php','_self',false);
            }
        </script>
