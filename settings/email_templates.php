...
if(isset($_POST['edit_email'])){ 
    ...
    $sqladd="UPDATE tbl_email_templates SET templates='$new_desc',status='$new_status' WHERE id='$new_id'";
    
    $result_update=mysqli_query($connect,$sqladd);
    if($result_update){
        
        echo '<script>window.location.href="email_templates.php"</script>';
    }
    else{
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_email_templates");
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><a href="email_details.php?id=<?php echo $row['id']?>"><?php echo $row['constant']; ?></a></td>
                                        ...
                                        <input type="hidden" id="table" name="table" value='tbl_email_templates'>
                                        <input type="hidden" id="returnto" name="returnto" value='../settings/email_templates.php'>
