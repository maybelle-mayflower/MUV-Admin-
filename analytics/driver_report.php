...
<html>
    <head>
        <head>
	<title>Analytics | Driver Report</title>
	<meta charset="utf-8">
						...
						<li>
							...
							<div id="subPages5" class="collapse ">
								<ul class="nav">
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        <li>
                                                                        <a href="#subPages5a" data-toggle="collapse" class="active"><span>Report</span><i class="icon-submenu lnr lnr-chevron-left"></i></a>
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="driver_report.php" class="active">Driver Report</a></li>
				...
				<div class="container-fluid">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Driver Report</h3>
                                        </div>
                                        <div style="margin: 10px; margin-bottom: 10px; ">
                                            <button type="button" id="getExp" class="btn btn-default btn-xs" onclick="">Export</button>
                                            <button type="button" id="getImp" class="btn btn-default btn-xs" onclick="">Import</button>
                                            ...
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td><a href="../fleet_tracking/driver_info.php?id='<?php echo $row['id']; ?>'"><?php echo $row['firstname']." ".$row['lastname']; ?></a></td>
                                                       <td><?php echo $row['email']; ?></td>
                                                       <td><?php echo $row['company_name']; ?></td>
                                                       <td><?php echo $row['mobile']; ?></td>
                                                       <td><?php echo $row['license_no']; ?></td>
                                                       <td><img src="../fleet_tracking/img/drivers/photo/<?php echo $row['license_no'].$row['photo']?>" class="img-thumbnail img-responsive" width="70" height="70"/></td>
                                                       <td>IN</td>
                                                   </tr>
                                                   <?php endwhile; ?>
                                               </tbody>
