...
if(isset($_POST['addDispatcher'])){ 
    ...
    $sqlupdate="INSERT INTO tbl_dispatcher (firstname, lastname, email, password, mobile, address, company, country, state, city, status) VALUES ('$new_firstname','$new_lastname','$new_email','$new_password','$new_mobile','$new_address','$new_fleetcompany','$new_country','$new_state','$new_city', 'active')";
    $result_update=mysqli_query($con,$sqlupdate);
    if($result_update){
        echo '<script>alert("Dispatcher Added!")</script>';
        $emailTemp = dispatcherReg($new_firstname, $new_email, $new_password);
        sendMail($new_name, $new_email, $emailTemp); 
        echo '<script>window.location.href="manage_dispatcher.php"</script>';
    }
    else{
        echo '<script>alert("Update Failed2: '. mysqli_error($con).'")</script>';
    }
}
?>
                                    ...
                                    <div class="modal-content">
                                        <div class="panel panel-headline">
                                            ...
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Add Dispatcher</h3>
                                                <div class="right">
                                                    <a href="manage_dispatcher.php" style="float: right;">Exit</a>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                                <form class="form-horizontal" action="add_dispatcher.php" method="post" onsubmit="return submitDriver()">
                                                    ...
                                                    <div class="box-body">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="text" class="form-control" id="email" name="email" onchange="checkMail()"  required="true">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="password" class="form-control" id="confirmpass" name="confirmpass" required="true" onchange="checkMatch();"  required="">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select class="form-control" id="txtconame" name="txtconame" required="">
                                                                    <?php
                                                                    getCompanies();
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                 <select class="form-control" id="txtstate" name="txtstate"  required="">
                                                    ...
                                                    <button type="submit" id="addDispatcher" name="addDispatcher" class="btn btn-default btn-sm" style="float: right;">Submit</button>
                                                </form>
                                            </div>
                                    </div>
                                </div>
...
function checkMail(){
        var dispatcher_email= $("#email").val();
            $.ajax({
                type:'post',
                url:'email_availability.php',// put your real file name 
                data:{dispatcher_email: dispatcher_email},
...
function sendMail($name, $email, $message){
    ...
    $to = "$name <$email>";
    $subject = "Dispatcher Registration Successful";
