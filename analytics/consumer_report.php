...
<html>
    <head>
        <head>
	<title>Analytics | Consumer Report</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
                                                                    ...
                                                                    <li><a href="dashboard.php" class="">Dashboard</a></li>
                                                                        ...
                                                                        <div id="subPages5a" class="collapse ">
                                                                            <ul class="nav">
                                                                                ...
                                                                                <li><a href="consumer_report.php" class="active">Consumer Report</a></li>
		...
		<div class="main">
                   <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Consumer Report</li>
                    </ol>
			<!-- MAIN CONTENT -->
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                        <div class="panel-heading">
                                                <h3 class="panel-title">Consumer Report</h3>
                                        </div>
                                    ...
                                    <div class="panel-body">
                                       <table style="margin: 10px;"class="table table-bordered table-responsive display" id="myTable" width="98.4%">
                                            <thead style="font: bolder">
                                               ...
                                               <tbody>
                                                   <?php
                                                   $result = mysqli_query($connect, "SELECT * FROM tbl_consumers");
