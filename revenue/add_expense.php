...
if(isset($_POST['addExpBtn'])){ 
    ...
    $exp_man = mysqli_real_escape_string($con,$_POST['expman']);
    $exp_cat = mysqli_real_escape_string($con,$_POST['expcat']);
    $exp_amt = mysqli_real_escape_string($con,$_POST['expamt']);
    $exp_date = mysqli_real_escape_string($con,$_POST['expdate']);
    $remarks = mysqli_real_escape_string($con,$_POST['remarks']);
	    
    $sqladd="INSERT INTO tbl_expense (exp_management, category_id, amount, exp_date, remarks) VALUES ('$exp_man','$exp_cat','$exp_amt','$exp_date','$remarks')";
    ...
    if($result_add){
        ...
        echo '<script>alert("Could not add Expense '. mysqli_error($connect).'")</script>';
    }
}
?>
...
<body>
				...
				<div class="container-fluid" style="height: auto;">
					<div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" action="add_expense.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" id="expman" name="expman" required="">
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" id="expamt" name="expamt" required="">
                                                    </div>
                                                </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <button type="submit" id="addExpBtn" name="addExpBtn" class="btn btn-default btn-sm" style=" float: right;">Submit</button>
	...
	<script src="../assets/scripts/klorofil-common.js"></script>
        ...
        <script>
            function goBack(){
                window.open('expense.php','_self',false);
            }
        </script>
</body>
</html>
